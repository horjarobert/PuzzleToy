...
namespace PuzzleToy
{
    public partial class level3 : UserControl
    {
        ...
        public void Correct()
        {
            if ((fin1.Image == misc3.Image) && (fin2.Image == misc5.Image) && (fin3.Image == misc7.Image) && (fin4.Image == misc6.Image) && (fin5.Image == misc1.Image) && (fin6.Image == misc8.Image) && (fin7.Image == misc2.Image) && (fin8.Image == misc9.Image) && (fin9.Image == misc4.Image))
            {
                MessageBox.Show("Congratulations!", "Level 3 completed!", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void panelMisc_Paint(object sender, PaintEventArgs e)
        {

        }

        private void misc1_Click(object sender, EventArgs e)
        {

        }

        private void misc4_Click(object sender, EventArgs e)
        {

        }

        private void misc7_Click(object sender, EventArgs e)
        {

        }

        private void misc8_Click(object sender, EventArgs e)
        {

        }

        private void misc5_Click(object sender, EventArgs e)
        {

        }

        private void misc2_Click(object sender, EventArgs e)
        {

        }

        private void misc3_Click(object sender, EventArgs e)
        {

        }

        private void misc6_Click(object sender, EventArgs e)
        {

        }

        private void misc9_Click(object sender, EventArgs e)
        {
        ...
        private void bar2_Click(object sender, EventArgs e)
        {

        }

        private void panelFin_Paint(object sender, PaintEventArgs e)
        {

        }

        private void fin7_Click(object sender, EventArgs e)
        {

        }

        private void fin4_Click(object sender, EventArgs e)
        {
        ...
        private void fin2_Click(object sender, EventArgs e)
        {

        }

        private void fin5_Click(object sender, EventArgs e)
        {

        }

        private void fin8_Click(object sender, EventArgs e)
        {

        }

        private void fin9_Click(object sender, EventArgs e)
        {

        }

        private void fin6_Click(object sender, EventArgs e)
        {

        }

        private void fin3_Click(object sender, EventArgs e)
        {
        ...
        private void titleTxtLvl3_Click(object sender, EventArgs e)
        {
