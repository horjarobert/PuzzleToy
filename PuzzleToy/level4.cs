...
namespace PuzzleToy
{
    public partial class level4 : UserControl
    {
        ...
        public void Correct()
        {
            if ((fin1.Image == misc9.Image) && (fin2.Image == misc8.Image) && (fin3.Image == misc4.Image) && (fin4.Image == misc5.Image) && (fin5.Image == misc6.Image) && (fin6.Image == misc2.Image) && (fin7.Image == misc1.Image) && (fin8.Image == misc7.Image) && (fin9.Image == misc3.Image))
            {
                MessageBox.Show("Congratulations!", "Level 4 completed!", MessageBoxButtons.OK, MessageBoxIcon.Information);
